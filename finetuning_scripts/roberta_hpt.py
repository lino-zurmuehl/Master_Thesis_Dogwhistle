...
# --- Phase 1: Grid search without saving checkpoints ---
grid_results = []
for idx, params in enumerate(param_combinations, 1):
    ...
    args = TrainingArguments(
        ...
        eval_steps=50,
        save_strategy="no",             # disable all checkpoint saves
...
# --- Phase 2: Retrain and save only top 3 trials ---
